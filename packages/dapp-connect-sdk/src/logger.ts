  ...
  public createScopedLogger(scope: string) {
    return {
      debug: (message: string, ...args: any[]) =>
        this.log(LogLevel.DEBUG, scope, message, ...args),
      info: (message: string, ...args: any[]) =>
        this.log(LogLevel.INFO, scope, message, ...args),
      warn: (message: string, ...args: any[]) =>
        this.log(LogLevel.WARN, scope, message, ...args),
      error: (message: string, ...args: any[]) =>
        this.log(LogLevel.ERROR, scope, message, ...args),
    };
  }
